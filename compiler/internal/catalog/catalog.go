...
var sourceDefinitions = []sourceDefinition{
	...
	{"config/environments/estate-health.yaml", "environment.schema.json", "Environment", "environments"},
	...
	{"config/integrations/estate-ci-observer.yaml", "integration.schema.json", "Integration", "integrations"},
	{"config/integrations/estate-ci-dispatcher.yaml", "integration.schema.json", "Integration", "integrations"},
...
var canonicalWorkflowInventories = map[string][]string{
	...
	".github": {
		...
		"reusable-scorecard.yml", "pull-request.yml", "estate-health.yml",
		"estate-ci-qualification.yml",
	},
	"bootstrap": {
